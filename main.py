    ...
    async with async_playwright() as p:
        ...
        for attempt in range(1, MAX_RETRIES + 1):
            try:
                ...
                # Odeslání úlohy do Anti-Captcha
                ...
                # Čekání na vyřešení CAPTCHA (max 40 sekund)
                captcha_text = None
                for _ in range(20):
                ...
                last_error = str(e)
                # Pokud pokus selhal a máme další pokusy, počkáme 2 sekundy
        ...
        raise HTTPException(
            status_code=500, 
            detail=f"CAPTCHA selhala i po {MAX_RETRIES} pokusech. Poslední chyba: {last_error}"
        )
